<?php
   if(isset($_FILES['image'])){
      ...
      if(empty($errors)==true) {
         move_uploaded_file($file_tmp,"blogimages/".$file_name);
         echo "Success";
      }else{
         print_r($errors);
      }
...
if($_SESSION['uname']){
 ...
 <section class="content" style="float:left;width:100%;margin-top:80px;background:#eee;">
   <div class="container">
      <h3 >Write Blog</h3>
     <div class="row" style="background:#eee;font-family: 'Roboto Condensed';padding:40px;">
       ...
       <form action = "" method = "POST" enctype = "multipart/form-data">
          ...
          <ul>
             <li>Sent file: blogimages/<?php echo $_FILES['image']['name'];  ?>
